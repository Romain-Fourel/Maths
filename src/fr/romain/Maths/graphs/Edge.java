 ...
 * @param <K>
 */
public class Edge<V,K extends Comparable<K>> {
	...
	public static<V,K extends Comparable<K>> Edge<V, K> connect(Vertex<V, K> prev,Vertex<V, K> dest, K weight){
		prev.connectTo(dest, weight);
		return new Edge<V, K>(prev, dest, weight);
	}
	
	public static<V,K extends Comparable<K>> Edge<V, K> bind(Vertex<V, K> v1,Vertex<V, K> v2,K weight){
	...
	public boolean isOriented() {
		 ...
		 */
		return prev.getWeightTo(dest).compareTo((dest.getWeightTo(prev)))==0;
	}
